          ...
          <div className="absolute right-3 top-3">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="size-8 opacity-0 transition-opacity group-hover/card:opacity-100 focus:opacity-100">
  ...
  return (
    <PageTransition>
      <div className="space-y-6">
        ...
        {/* Driver Detail Sheet (from search) */}
